...
def fast_9_lr_parameters_2conv_head(model, lr_group, arch_search=None):
    rest_name = []
    figure_ = []
    for name, param in model.named_parameters():
        rest_name.append(param)
...
def prepare(args, epoch):
    ...
    optimizer = torch.optim.SGD(fast_9_lr_parameters_2conv_head(net, lr_group),
                                momentum=0.9,
                                weight_decay=5e-4)
...
def train(epoch, batches=-1):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        loc_conv_1 = 0
        loc_conv_2 = 8
        current_lr_1 = scheduler.get_lr()[loc_conv_1]
        current_lr_2 = scheduler.get_lr()[loc_conv_2]
        # print('{:.2e},{:.2e}'.format(current_lr_1, current_lr_2))
        current_lr_1 = '{:.2e}'.format(current_lr_1)
        current_lr_2 = '{:.2e}'.format(current_lr_2)
        epoch_index = str(epoch).zfill(2)
        # net_save_path = os.path.join('./checkpoint/exp1_{}_net_params_loc{}_{:.2f}_loc{}_{:.2f}.pkl'.format(epoch_index, loc_conv_1, current_lr_1, loc_conv_2, current_lr_2))
        net_save_path = os.path.join('./checkpoint/exp2_{}_net_params_loc{}_{}_loc{}_{}.pkl'.format(epoch_index, loc_conv_1, current_lr_1, loc_conv_2, current_lr_2))
        # net_save_path = os.path.join('./checkpoint/exp2_{}_net_params_loc{}_{}_loc{}_{}.pkl'.format(epoch_index, loc_conv_1, current_lr_1, loc_conv_2, current_lr_2))
...
if __name__ == '__main__':
    ...
    try:
        ...
        RCV_CONFIG = {
            ...
            "layer2_conv0_3_3": 0.01,
            "layer3_conv0_3_3": 0.01,
        ...
        RCV_CONFIG = {
            ...
            "prep_1": 0.02554,
            "prep_2": 0.09698,
            "layer1_conv0_3_3": 0.02289,
            "layer1_conv1_3_3": 0.05213,
            "layer1_conv2_3_3": 0.0493,
            "layer2_conv0_3_3": 0.09933,
            "layer3_conv0_3_3": 0.01155,
            "layer3_conv1_3_3": 0.00004,
            "layer3_conv2_3_3": 0.02157,
            "rest": 0.00082
            }
        ...
        RCV_CONFIG = {
            ...
            "prep_1": 0.01126,
            "prep_2": 0.08281,
            "layer1_conv0_3_3": 0.01471,
            "layer1_conv1_3_3": 0.09948,
            "layer1_conv2_3_3": 0.0453,
            "layer2_conv0_3_3": 0.03915,
            "layer3_conv0_3_3": 0.01609,
            "layer3_conv1_3_3": 0.00095,
            "layer3_conv2_3_3": 0.03843,
            "rest": 0.00124
            }
        """
