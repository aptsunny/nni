...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, choice=None):
        ...
        self.conbine = nn.Sequential(
            self.dwconv_first(inplanes, planes),
            self.dwconv_second(inplanes, planes),
        )

    def dwconv_first(self, in_channels, out_channels, stride=1):
        ...
        return self.dwconv_1

    def dwconv_second(self, in_channels, out_channels, stride=1):
...
class Network_cifar(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv1 = self.dwconv(3, channels['prep'])
        ...
        self.conv2 = self.dwconv(channels['prep'], channels['layer1'])
        ...
        self.conv3 = self.dwconv(channels['layer1'], channels['layer2'])
        ...
        self.conv4 = self.dwconv(channels['layer2'], channels['layer3'])
