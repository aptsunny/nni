...
def train_nni(args, net, device, epoch, batches=-1):
    ...
    for batch_idx in range(batches):
        ...
        if args.constrain_flops:
            ...
            get_random_cand = lambda: tuple(np.random.randint(4) for i in range(7))
...
def prepare(args, RCV_CONFIG, RCV_CONFIG_default):
    args.momentum = RCV_CONFIG_default['momentum']
    args.bn_process = True if RCV_CONFIG_default['bn_process']=='True' else False
    args.learning_rate = RCV_CONFIG_default['learning_rate']
    args.weight_decay = RCV_CONFIG_default['weight_decay']
    args.label_smooth = RCV_CONFIG_default['label_smooth']
    args.lr_scheduler = RCV_CONFIG_default['lr_scheduler']
    args.randAugment = True if RCV_CONFIG_default['randAugment'] == 'True' else False

    args.lr_group = [
                RCV_CONFIG['prep'],

                RCV_CONFIG['layer1_conv0_3_3'],
                RCV_CONFIG['layer1_conv1_3_3'],
                RCV_CONFIG['layer1_conv2_3_3'],
                RCV_CONFIG['layer2_conv0_3_3'],
                RCV_CONFIG['layer3_conv0_3_3'],
                RCV_CONFIG['layer3_conv1_3_3'],
                RCV_CONFIG['layer3_conv2_3_3'],

                RCV_CONFIG['layer1_dwconv0_3_3'],
                RCV_CONFIG['layer1_dwconv1_3_3'],
                RCV_CONFIG['layer1_dwconv2_3_3'],
                RCV_CONFIG['layer2_dwconv0_3_3'],
                RCV_CONFIG['layer3_dwconv0_3_3'],
                RCV_CONFIG['layer3_dwconv1_3_3'],
                RCV_CONFIG['layer3_dwconv2_3_3'],
...
if __name__ == "__main__":
    ...
    try:
        ...
        RCV_CONFIG = {
            ...
            "layer1_dwconv0_3_3": 0.06077,
            "layer1_dwconv1_3_3": 0.09482,
            "layer1_dwconv2_3_3": 0.01448,
            "layer2_dwconv0_3_3": 0.05309,
            "layer3_dwconv0_3_3": 0.03843,
            "layer3_dwconv1_3_3": 0.00401,
            "layer3_dwconv2_3_3": 0.09642,

            "rest": 0.00063}
        """

        RCV_CONFIG_default = {
            "learning_rate": 0.06078498555747216,
            "weight_decay": 0.00031250944304909474,
            "momentum": 0.9,
            "bn_process": "False",
            "label_smooth": 0,
            "lr_scheduler": "Lambda",
        ...
        model, device, train_step, valid_step = prepare(args, RCV_CONFIG, RCV_CONFIG_default)
        start_epoch = 1
