...
class Network_cifar(nn.Module):
    def __init__(self, num_classes=10, layer_1="3_3", layer_3="3_3"):
        super(Network_cifar, self).__init__()
        choice = {"3_3":0, "3_5":1, "3_7":2, "5_3":3, "5_5":4, "5_7":5, "7_3":6, "7_5":7, "7_7":8}
        ...
        self.layer1_features.append(
            BasicBlock(channels['layer1'], channels['layer1'], stride=1, choice=choice[layer_1]))
        ...
        self.layer3_features.append(
            BasicBlock(channels['layer3'], channels['layer3'], stride=1, choice=choice[layer_3])) #
...
class Network_cifar_(nn.Module):
    def __init__(self, num_classes=10):
        super(Network_cifar_, self).__init__()
        channels = {'prep': 64, 'layer1': 128, 'layer2': 256, 'layer3': 512}
        # prep
        self.conv1 = self.conv3x3(3, channels['prep'])
        self.bn1 = nn.BatchNorm2d(channels['prep'])
