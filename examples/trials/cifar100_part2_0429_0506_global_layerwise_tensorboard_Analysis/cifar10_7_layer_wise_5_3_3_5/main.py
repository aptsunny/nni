...
def prepare(args, epoch):
    ...
    net = SuperNetwork_3(shadow_bn=True, layers=3, classes=100, sample={0:[5,3],2:[3,5]})
    ...
    optimizer = torch.optim.SGD(fast_9_lr_parameters(net, lr_group),
                                momentum=0.9,
                                weight_decay=5e-4)
