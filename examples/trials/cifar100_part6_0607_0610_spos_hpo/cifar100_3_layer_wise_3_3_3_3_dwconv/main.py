...
def prepare(args, epoch):
    ...
    lr_group = [args['prep'],
                args['layer1_dwconv0_3_3'],
                args['layer1_dwconv1_3_3'],
                args['layer1_dwconv2_3_3'],
                args['layer2_dwconv0_3_3'],
                args['layer3_dwconv0_3_3'],
                args['layer3_dwconv1_3_3'],
                args['layer3_dwconv2_3_3'],
                args['rest']]
